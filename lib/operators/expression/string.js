 ...
 * @returns {string|*}
 */
export function $concat (obj, expr) {
 ...
 * @return {*}
 */
export function $indexOfBytes (obj, expr) {
 ...
 */
export function $split (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @return {Number}
 */
export function $strLenBytes (obj, expr) {
 ...
 * @return {Number}
 */
export function $strLenCP (obj, expr) {
 ...
 * @returns {number}
 */
export function $strcasecmp (obj, expr) {
  let args = computeValue(obj, expr)
  let a = args[0]
  let b = args[1]
 ...
 * @returns {string}
 */
export function $substrBytes (obj, expr) {
  let args = computeValue(obj, expr)
  let s = args[0]
  let index = args[1]
  let count = args[2]
 ...
 * @returns {string}
 */
export function $substr (obj, expr) {
  let args = computeValue(obj, expr)
  let s = args[0]
  let index = args[1]
  let count = args[2]
...
export function $substrCP (obj, expr) {
 ...
 * @returns {string}
 */
export function $toLower (obj, expr) {
 ...
 * @returns {string}
 */
export function $toUpper (obj, expr) {
  let value = computeValue(obj, expr)
