 ...
 * @param expr
 */
export function $setEquals (obj, expr) {
 ...
 * @param expr
 */
export function $setIntersection (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @param expr
 */
export function  $setDifference (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @param expr
 */
export function $setUnion (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @param expr
 */
export function $setIsSubset (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @param expr
 */
export function $anyElementTrue (obj, expr) {
 ...
 * @param expr
 */
export function $allElementsTrue (obj, expr) {
  // mongodb nests the array expression in another
  let args = computeValue(obj, expr)[0]
