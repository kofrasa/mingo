 ...
 * @return {*}
 */
export function $arrayElemAt (obj, expr) {
 ...
 */
export function $arrayToObject (obj, expr) {
  let arr = computeValue(obj, expr)
 ...
 * @return {*}
 */
export function $concatArrays (obj, expr) {
 ...
 * @return {*}      [description]
 */
export function $filter (obj, expr) {
 ...
 * @return {*}
 */
export function $indexOfArray (obj, expr) {
 ...
 * @return {Boolean}
 */
export function $isArray (obj, expr) {
 ...
 */
export function $objectToArray (obj, expr) {
 ...
 * @return {*}
 */
export function $range (obj, expr) {
  let arr = computeValue(obj, expr)
  let start = arr[0]
  let end = arr[1]
  let step = arr[2] || 1
 ...
 * @param {*} expr
 */
export function $reduce (obj, expr) {
  let input = computeValue(obj, expr.input)
 ...
 * @return {*}
 */
export function $reverseArray (obj, expr) {
  let arr = computeValue(obj, expr)
 ...
 * @return {*}
 */
export function $slice (obj, expr) {
  let arr = computeValue(obj, expr)
 ...
 * @param {*} expr
 */
export function $mergeObjects (obj, expr) {
