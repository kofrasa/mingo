 ...
 * @returns {number}
 */
export function $divide (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @returns {number}
 */
export function $floor (obj, expr) {
  let arg = computeValue(obj, expr)
  if (isNil(arg)) return null
 ...
 * @returns {number}
 */
export function $log10 (obj, expr) {
  let arg = computeValue(obj, expr)
  if (isNil(arg)) return null
 ...
 * @returns {Object}
 */
export function $multiply (obj, expr) {
  let args = computeValue(obj, expr)
 ...
 * @param {*} expr
 */
export function $round (obj, expr) {
  let args = computeValue(obj, expr)
  let num = args[0]
  let place = args[1]
 ...
 * @returns {number}
 */
export function $subtract (obj, expr) {
  let args = computeValue(obj, expr)
  return args[0] - args[1]
}
 ...
 * @returns {number}
 */
export function $trunc (obj, expr) {
