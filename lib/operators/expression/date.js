 ...
 * @param expr
 */
export function $dayOfYear (obj, expr) {
 ...
 * @param expr
 */
export function $dayOfMonth (obj, expr) {
  let d = computeValue(obj, expr)
  return d.getDate()
}
 ...
 * @param expr
 */
export function $dayOfWeek (obj, expr) {
  let d = computeValue(obj, expr)
  return d.getDay() + 1
}
 ...
 * @param expr
 */
export function $month (obj, expr) {
  let d = computeValue(obj, expr)
  return d.getMonth() + 1
}
 ...
 * @param expr
 */
export function $minute (obj, expr) {
  let d = computeValue(obj, expr)
  return d.getMinutes()
}
 ...
 * @param expr
 */
export function $second (obj, expr) {
  let d = computeValue(obj, expr)
  return d.getSeconds()
}
 ...
 * @param expr
 */
export function $millisecond (obj, expr) {
  let d = computeValue(obj, expr)
 ...
 */
export function $dateToString (obj, expr) {
  let fmt = expr['format']
