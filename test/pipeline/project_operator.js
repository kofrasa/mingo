...
samples.runTestPipeline("$project pipeline operator", [
  ...
  {
    messge: "exclude fields from embedded documents",
    input: [
      {
        "_id" : 1,
        title: "abc123",
  ...
  {
    messge: "exclude fields from embedded documents using nested array syntax",
    input: [
      {
        "_id" : 1,
        title: "abc123",
  ...
  {
    message: "project include specific fields from embedded documents using nested array syntax",
    input: [
      { _id: 1, user: "1234", stop: { title: "book1", author: "xyz", page: 32 } },
      { _id: 2, user: "7890", stop: [ { title: "book2", author: "abc", page: 5 }, { title: "book3", author: "ijk", page: 100 } ] }
    ],
