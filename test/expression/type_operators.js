...
support.runTest('Type operators', {
  ...
  $convert: [
    ...
    [ { input: 5.5000, to: "int"}, 5 ],
    [ { input: 9223372036000.000, to: "int"}, 'error', {err: true } ],
    [ { input: 9223372036854775808.0, to: "long"}, 'error', {err: true } ],
    [
      {
        input:  9223372036000.000,
        to: "int",
    ...
    [ { input: new Date("2018-03-27T05:04:47.890Z"), to: "decimal" }, 1522127087890 ],
    [ { input: "5e10", to: "double" }, 50000000000 ],

    // date
    [ { input: 120000000000.5, to: "date"}, new Date("1973-10-20T21:20:00Z") ],
    [ { input: 1253372036000.50, to: "date"}, new Date("2009-09-19T14:53:56Z") ],
    ...
    [ { input: "2018-03-20 11:00:06 +0500", to: "date" }, new Date("2018-03-20T06:00:06Z") ],
