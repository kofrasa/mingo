...
(function (global, factory) {
  ...
  })(BsonType || (BsonType = {})); // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes
    ...
    _createClass(Aggregator, [{
      ...
      value: function stream(collection) {
        ...
        if (!isEmpty(this.__pipeline)) {
          ...
          each(this.__pipeline, function (operator) {
      ...
      if (iterator === null) {
        collection.each(function (obj) {
          ...
          if (isNil(key) || key < lower || key >= upper) {
            ...
            var index = findIndex(boundaries, key);
